...
class UserHelper
{
    ...
    public function __construct(private EntityManagerInterface $em, private UserPasswordHasherInterface $userPasswordHasher, private Security $security)
    {
    }
    ...
    {
        $alphabet = '#@!ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuv1234567890';
    ...
    // }
    static function getAuth($user,$role){
