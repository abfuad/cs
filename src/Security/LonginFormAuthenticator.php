...
// use Symfony\Bundle\SecurityBundle\Exception\CustomUserMessageAuthenticationException;

class LonginFormAuthenticator extends AbstractLoginFormAuthenticator
{
    use TargetPathTrait;
